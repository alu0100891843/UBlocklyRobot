...
namespace UBlockly
{
    ...
    public class Logic_Compare_Cmdtor : EnumeratorCmdtor
    {
        protected override IEnumerator Execute(Block block)
        {
            ...
            // else{
            //     Debug.Log(argument0.Type.ToString());
            //     Debug.Log(argument0.BooleanValue);
            // }
            
            DataStruct returnData = new DataStruct(false);
            if (argument0.Type.ToString() == "Boolean"){
                switch (op){
                    case "EQ":
                        returnData.BooleanValue = argument0.BooleanValue == argument1.BooleanValue;
                        Debug.Log(returnData.BooleanValue);
                        break;
            ...
            if (argument0.Type.ToString() == "Number"){
                switch (op){
                    case "EQ":
            ...
            if (argument0.Type.ToString() == "String"){
                switch (op){
                    case "EQ":
                        returnData.BooleanValue = argument0.StringValue == argument1.StringValue;
                        break;
